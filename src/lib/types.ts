...
export type Service = { id: string; solicitacao_id: string; orcamento_id: string; oficina_id: string; status: ServiceStatus; data_agendada: string | null; data_inicio: string | null; data_conclusao: string | null; observacoes: string | null; updated_at: string }
